...
$(document).ready(() => {
    ...
    $(".newgame").click(() => {
        if (i >= 0) {
            ...
            if (choix2) {
                max = Math.max(
                    playerarray[a].calculpendantmatch(),
                    playerarray[b].calculpendantmatch()
                );
        ...
        choix = confirm(
            "Voulez vous commencer une nouvelle partie OK pour OUI et Annuler pour NON"
        );
        if (choix) {
            i++;
            a += 2;
            ...
            $(".newgame").html(
                '<i class="fa-solid fa-circle-plus fa  p-0" style="color: #e32400;margin-right: 2%;"></i>'
            );
            $(".newgame").show(1500);
            $(".afaire").show(1500);
    ...
    class Game {
        ...
        checkGagnant(player) {
            if (
                player.getglobal() >= 100 ||
                player.calculpendantmatch() >= 100
            ) {
                return true;
            } else {
                return false;
    ...
    function affichede(valeur) {
        switch (valeur) {
            case 1:
                return '<div class="shadow-lg point">  </div>';
            case 2:
                return `<div class="row row-cols-2 h-100 align-items-center w-100 m-0">
        ...
        <div class="col p-0"><div class="shadow-lg point">  </div></div>
            ...
            case 3:
                return `<div class="row row-cols-3 h-100 align-items-center w-100 m-0">
        <div class="col p-0"><div class="shadow-lg point">  </div></div>
        <div class="col p-0"></div>
        <div class="col p-0"></div>
        <div class="col p-0"></div>
